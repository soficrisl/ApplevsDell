...
public class BothGUI extends javax.swing.JFrame {
     ...
     */
    public BothGUI(Empresa apple, Empresa dell) {
        initComponents();
        this.dell=dell;
        this.apple=apple;
    }
    ...
    private void exitbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exitbuttonActionPerformed
        ...
        array[0] = apple.getDays_in_mls(); 
        array[1] = apple.getDays_to_hand_in(); 
        array[2] = Integer.parseInt(workassemapple.getText());
        array[3] = Integer.parseInt(workmbapple.getText());
        array[4] = Integer.parseInt(workcpuapple.getText());
        array[5] = Integer.parseInt(workramapple.getText());
        array[6] = Integer.parseInt(workpowerapple.getText());
        array[7] = Integer.parseInt(workgraphicapple.getText());
        array[8] = Integer.parseInt(workassemdell.getText());
        array[9] = Integer.parseInt(workmbdell.getText());
        array[10] = Integer.parseInt(workcpudell.getText());
        array[11] = Integer.parseInt(workramdell.getText());
        array[12] = Integer.parseInt(workpowerdell.getText());
        array[13] = Integer.parseInt(workgraphicdell.getText());
